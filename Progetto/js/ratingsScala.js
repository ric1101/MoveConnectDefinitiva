...
function recuperaDatiRecensione(id) {
    ...
    fetch(`https://127.0.0.1/api/scala/relazioneScalaPerId/${idRel}`)
        .then((res) => res.json())
        .then((data) => {
...
function inviaRecensione(choose) {
    ...
    class Recensione {
        constructor(relazioneScalaId, relazioneAziendaRichiedenteScalaId, relazioneAziendaAccettataScalaId, valutazione, commento, stato) {
    ...
    if (choose == 1) {
        ...
        fetch(`https://127.0.0.1/api/scala/recensitaRelazioneScalaProponente/${idRecNumber}`, {
            method: "PUT",
            headers: {
        ...
        fetch(`https://127.0.0.1/api/scala/recensitaRelazioneScalaRichiedente/${idRecNumber}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    fetch(`https://127.0.0.1/api/scala/recensioneScala`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
