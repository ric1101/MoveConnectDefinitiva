...
function interessamentoDeposito(richiestaId, aziendaIdAccesso, emailAziendale, idAzienda, abb) {
    ...
    if (abb == 'base' || abb == 'plus') {
        ...
        fetch(`https://moveconnect.it/api/depositoMagazzino/modificaMagazzinoIdRichiesta/${richiestaId}/${aziendaIdAccesso}`, {
            method: "PUT",
            headers: {
        ...
        fetch(`https://moveconnect.it/api/propostaMagazzino/interessataPropostaMagazzino`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
