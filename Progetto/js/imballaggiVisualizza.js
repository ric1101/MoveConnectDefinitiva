            ...
            if (element.stato == 'APERTA' || element.stato == 'INTERESSATA') {
                ...
                if (element.azienda.id != id) {
                    ...
                    function visualizzaRecord() {
                        ...
                        <td class="text-center" data-eventoid="1"><a class="btn btn-dark linkImballi" href="./infoRichiesteImballi.html" target="_blank" data-evento-id="${element.id}">INFO</a></td>
