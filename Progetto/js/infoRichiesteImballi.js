...
function interessamentoImballi(richiestaId, aziendaIdAccesso, emailAziendale, idAzienda, abb) {
    ...
    if (abb == 'base' || abb == 'plus') {
        ...
        fetch(`https://3.123.172.27/api/consegnaImballi/modificaImballiIdRichiesta/${richiestaId}/${aziendaIdAccesso}`, {
            method: "PUT",
            headers: {
        ...
        fetch(`https://3.123.172.27/api/propostaImballi/interessataPropostaImballi`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
