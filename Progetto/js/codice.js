...
function fetchInvio() {
  ...
  fetch(`https://3.123.172.27/api/azienda/verify-azienda?username=${username}&verificationCode=${codice.value}`, {
    method: "PUT",
    headers: {
...
function rigenera(){
  ...
  fetch(`https://3.123.172.27/api/azienda/rigenera-codice?username=${username}`,{ 
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
    },
