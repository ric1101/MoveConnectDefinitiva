...
function recuperaDatiRecensione(id) {
    ...
    fetch(`https://3.123.172.27/api/trattazza/relazioneImballiPerId/${idRel}`)
        .then((res) => res.json())
        .then((data) => {
...
function inviaRecensione(choose) {
    ...
    class Recensione {
        constructor(relazioneTrattaId, relazioneAziendaRichiedenteTrattaId, relazioneAziendaAccettataTrattaId, valutazione, commento, stato) {
            (this.relazioneTrattaId = relazioneTrattaId),
                (this.relazioneAziendaRichiedenteTrattaId = relazioneAziendaRichiedenteTrattaId),
                (this.relazioneAziendaAccettataTrattaId = relazioneAziendaAccettataTrattaId),
    ...
    if (choose == 1) {
        ...
        fetch(`https://3.123.172.27/api/trattazza/recensitaRelazioneTrattaProponente/${idRecNumber}`, {
            method: "PUT",
            headers: {
        ...
        fetch(`https://3.123.172.27/api/trattazza/recensitaRelazioneTrattaRichiedente/${idRecNumber}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    fetch(`https://3.123.172.27/api/trattazza/recensioneTratta`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
