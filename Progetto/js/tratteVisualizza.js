...
function fetchTratte(id) {
    ...
    let URLB = `https://127.0.0.1/api/tratta/tuttLeTratteConAzienda`;
    fetch(URLB)
        .then((res) => res.json())
        .then((data) => {
        ...
        dati.forEach(element => {
            ...
            if (element.stato == 'APERTA'|| element.stato == 'INTERESSATA') {
                ...
                if (element.azienda.id != id) {
                    ...
                    fetch(`https://127.0.0.1/api/trattazza/byAziendaRichiesta?trattaId=${element.id}`)
                        .then((res) => res.json())
                        .then((data) => {
...
async function filtriRegionePartenza(regione, id) {
    ...
    await fetch(`https://127.0.0.1/api/tratta/tutteLeTratteConAziendaPerRegionePartenza/${regione}`)
        .then((res) => res.json())
        .then((data) => {
...
async function filtriRegionePartenzaArrivo(regionePartenza, regioneArrivo, id) {
    ...
    await fetch(`https://127.0.0.1/api/tratta/tutteLetratteConAziendaTutto?paesePartenza=${regionePartenza}&paeseArrivo=${regioneArrivo}`)
        .then((res) => res.json())
        .then((data) => {
...
async function filtriRegionePartenzaArrivoVeicolo(regionePartenza, regioneArrivo, veicolo, id) {
    ...
    await fetch(`https://127.0.0.1/api/tratta/tutteLetratteConAziendaTutto?paesePartenza=${regionePartenza}&paeseArrivo=${regioneArrivo}&tipoDiVeicolo=${veicolo}`)
        .then((res) => res.json())
        .then((data) => {
...
async function filtriRegionePartenzaVeicolo(regionePartenza, veicolo, id) {
    ...
    await fetch(`https://127.0.0.1/api/tratta/tutteLetratteConAziendaTutto?paesePartenza=${regionePartenza}&tipoDiVeicolo=${veicolo}`)
        .then((res) => res.json())
        .then((data) => {
...
async function filtriRegioneArrivoVeicolo(regioneArrivo, veicolo, id) {
    ...
    await fetch(`https://127.0.0.1/api/tratta/tutteLetratteConAziendaTutto?paeseArrivo=${regioneArrivo}&tipoDiVeicolo=${veicolo}`)
        .then((res) => res.json())
        .then((data) => {
...
async function filtriRegioneArrivo(regioneArrivo, id) {
    ...
    await fetch(`https://127.0.0.1/api/tratta/tutteLeTratteConAziendaPerRegioneArrivo/${regioneArrivo}`)
        .then((res) => res.json())
        .then((data) => {
...
async function filtriVeicolo(veicolo, id) {
    ...
    await fetch(`https://127.0.0.1/api/tratta/tutteLetratteConAziendaTutto?tipoDiVeicolo=${veicolo}`)
        .then((res) => res.json())
        .then((data) => {
