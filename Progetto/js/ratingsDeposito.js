...
class Recensione {
    constructor(relazioneMagazzinoId, relazioneAziendaRichiedenteMagazzinoId, relazioneAziendaAccettataMagazzinoId, valutazione, commentoAziendaRichiedente, commentoAziendaAccettata) {
...
function inviaRecensione() {
    ...
    fetch(`http://127.0.0.1:8080/api/propostaMagazzino/recensitaRelazioneMagazzino/${idRel}`, {
        method: "PUT",
        headers: {
            "Content-Type": "application/json",
        },
