...
async function articolo(dati) {
    ...
    console.log(dati.img);
        ...
        let art = `<div class="row p-2">
            ...
            <div class="row gg p-2">
                <div class="col-md-1 col-sm-1"></div>
                <div class="col-md-2 col-sm-2 p-2 imgPexels" style="background-color: #1B2023;">
                    <div class="row" >
                ...
                <div class="col-md-8 col-sm-8 containerImg" style="background-image: url('${dati.img}');">
